...
INSERT INTO `aplicacion_periodos` VALUES (2,'CAPTURA DE CALIFICACIONES FINALES',15),(3,'CIERRE DE PERIODOS ESCOLARES',8),(4,'CALIFICACIONES PARCIALES, GESTION DE CURSO',1),(5,'CAPTURA DE EXAMENES ESPECIALES',1),(6,'PROCESO DE REINSCRIPCION',1),(7,'AUTORIZACION DE RESIDENCIAS DEP',1);
...
INSERT INTO `avisos` VALUES (3,'Nuevo aviso','Esto es una prueba','2024-01-09');
...
INSERT INTO `avisos_usuarios` VALUES (3,2,1);
...
INSERT INTO `diashorario` VALUES (3,'12:00:00','13:00:00','Lunes',1),(4,'12:00:00','14:00:00','Jueves',1);
...
INSERT INTO `horarios_docentes` VALUES (1,1,2);
...
INSERT INTO `model_has_permissions` VALUES (1,'App\\Models\\User',7),(3,'App\\Models\\User',7);
...
INSERT INTO `model_has_roles` VALUES (7,'App\\Models\\User',1),(11,'App\\Models\\User',2),(2,'App\\Models\\User',3),(4,'App\\Models\\User',4),(2,'App\\Models\\User',5),(3,'App\\Models\\User',7),(10,'App\\Models\\User',8),(2,'App\\Models\\User',9);
...
INSERT INTO `permisoscarreras` VALUES (1,1,7);
...
INSERT INTO `personal` VALUES (1,'Torrez','Gomex','Samuel','IRY64647777U8','Morelos','2024-01-05','Masculino','Soltero','Cuernavaca','Bugambilias','53491','Cuernavaca','Morelos','7775631209','IRY64678EYYEU2134R','Samuel05@gmail.con','Doctorado',NULL,NULL,9,0,0,'Computacion y mecatronica',NULL,NULL,'Dr','Docente',6312,'A',2001,12,2001,5,2002,3,2002,7,'Docentes','2024-01-09',NULL,NULL,1,2,2),(2,'Perez','Velazquez','Diana','URIAQWEE8839U','CDMX','2001-06-09','Masculino','Soltero','Morelos','Clavel','89234','Jiutepec','Morelos','7773214557','URIAQWEE8839UWIERT','DianaVel09@gmail.com','Profesional','Maestria',NULL,8,7,0,'Contabilidad','Recursos Humanos',NULL,'Mr','Administrativo',4612,'A',2008,4,2004,2,2005,3,2009,4,'Administrativas','2024-01-09',NULL,NULL,1,16,16);
...
INSERT INTO `plazas` VALUES (1,'A3091','18','2',36,20,0,6,'2024-01-09 21:47:21','2024-01-09 21:47:21'),(2,'A4095','14','1',46,20,0,2,'2024-01-09 21:47:45','2024-01-09 21:48:20'),(3,'B6097','68','14',36,20,0,13,'2024-01-09 21:48:05','2024-01-09 21:48:05');
...
INSERT INTO `sessions` VALUES ('QIyer6w1fVx6f88Tx1tYu9ly9RJk2cLolINwSoZY',2,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36 OPR/105.0.0.0','',1704822816);
...
-- Dump completed on 2024-01-09 11:54:01
