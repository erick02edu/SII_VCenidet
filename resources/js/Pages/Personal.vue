    ...
    <div id="modalContainer">
            ...
            <form @submit.prevent="crearAula"  class="w-full max-w-lg">
                    <div class="flex flex-wrap -mx-3 mb-6">
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input id="NombreAula" v-model="NuevoPersonal.RFC"  class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"  type="text" placeholder="XXXXXXXXXXXXX">
                        </div>
                        ...
                        <div class="w-full md:w-1/2 px-3">
                            ...
                            <input id="Capacidad" v-model="NuevoPersonal.Nombre" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"  type="text" placeholder="0">
                        </div>
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input id="NombreAula" v-model="NuevoPersonal.ApellidoP"  class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"  type="text" placeholder="">
                        </div>
                        ...
                        <div class="w-full md:w-1/2 px-3">
                            ...
                            <input id="Capacidad" v-model="NuevoPersonal.ApellidoM" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"  type="text" placeholder="">
                        </div>
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input id="NombreAula" v-model="NuevoPersonal.FechaNacimiento"  class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"  type="date" placeholder="">
                        </div>
                        ...
                        <div class="w-full md:w-1/2 px-3">
                            ...
                            <input id="Capacidad" v-model="NuevoPersonal.numTarjeta" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"  type="number" placeholder="0">
                        </div>
                        ...
                        <div class="w-full md:w-1/2 px-3">
                            ...
                            <select class="md:w-6/7 appearance-none bg-white border-gray-300 py-3 px-4 rounded leading-tight focus:outline-none focus-border blue-500 text-gray-700 border" name="categorias" v-model="NuevoPersonal.idPlaza" required>
                        ...
                        <div class="w-full md:w-1/2 px-3">
                            ...
                            <input type="radio" value="A" name="Estatus" v-model="NuevoPersonal.estatus" required> Alta <br>
                            <input type="radio" value="B" name="Estatus" v-model="NuevoPersonal.estatus" required> Baja
        ...
        <div class="inline-block min-w-full overflow-hidden rounded-lg shadow">
            <table class="w-full whitespace-no-wrap">
                ...
                <tbody>
                    <tr v-for="persona in personal" :key="persona.id" class="text-gray-700">
                        <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">{{ persona.id }}</p>
                        </td>
                        <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">{{ persona.Nombre }}</p>
                        </td>
                        <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">{{ persona.ApellidoP }}</p>
                        </td>
                        <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">{{ persona.ApellidoM }}</p>
                        </td>

                        <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">

                            <Link :href="route('Aulas.edit',persona.id)" class="p-3 rounded-md bg-[#014E82] mx-2 ">
                            ...
                            <a type="button" @click="showDelete(persona.id)" class="p-3 rounded-md bg-[#dc2626] mx-2">
                                    ...
                                    <div>
                                        <div :class="{ hidden: !isvisibleDelete }" v-bind:id="`Modal${persona.id}`" tabindex="-1" class="fixed inset-0 flex items-center justify-center z-50">
