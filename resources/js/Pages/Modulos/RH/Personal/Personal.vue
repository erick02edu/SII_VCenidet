<template>
                ...
                <tbody>
                    ...
                    >
                        ...
                        v-if="$page.props.user.roles.includes('Recursos Humanos')">
                            ...
                            v-if="$page.props.user.roles.includes('Recursos Humanos')">
                                <strong><i class="fa-solid fa-pen text-white pr-2"></i>Editar</strong>
                            </Link>
                            ...
                            <!-- <button @click="showElement(persona.id,persona.idPlaza)" class="p-3 rounded-md bg-[#dc2626] mx-2 inline-flex mb-2  text-white"
                            v-if="$page.props.user.roles.includes('Usuario RH') && persona.Estatus=='A'">
                                <strong class="inline-flex">
                                    <i class="fa-solid fa-circle-minus pt-1 pr-1"></i>
                                    Plaza
                                </strong>
                            </button> -->
                        </td>
                    ...
                    <!-- <tr v-for="(persona,index) in registrosCompletos"  v-if="PersonalBuscar=='' && DepartamentoSeleccionado==0" v-bind:id="`fila${persona.id}`"  class="text-gray-700"
                    >
                        ...
                        <td class="border-b border-gray-200 dark:border-slate-700  bg-white dark:bg-slate-800 px-5 py-5 text-xs"
                        v-if="$page.props.user.roles.includes('Usuario RH')">
                            <strong class="text-[#dc2626] whitespace-no-wrap" v-if="persona.Estatus=='B'">
 ...
 -->
        ...
        <div v-if="personal==''" class=" text-xl w-full mt-14 text-center"> <i class="fa-solid fa-magnifying-glass dark:text-white"></i>
