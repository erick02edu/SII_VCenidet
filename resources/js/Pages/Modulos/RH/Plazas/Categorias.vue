<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="inline-flex w-full" >
            ...
            <!--Seccion filtro para campo de busqueda-->
            <div class="relative inline-block text-left pl-3 align-top ">
                ...
                <div v-if="MostrarFiltro" class="z-50 origin-top-right absolute right-0 mt-2 w-32 mb-6 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5" role="menu" aria-orientation="vertical" aria-labelledby="dropdown-menu-button" tabindex="-1">
                    ...
                    <span @click="SeleccionarCampo('Descripcion','Descripcion')" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-slate-500 dark:text-gray-200">Descripción</span>
                    </div>
            ...
            <!--Boton para abrir modal para registrar una nueva categoria-->
            ...
            v-tippy="{
                content:'Agregar categoria de plaza',
                placement: 'top' ,
                arrow: true,
                arrowType: 'MyArrow',
                theme: 'MiThemeBlue'
        ...
        <!--Modal para registrar una nieva categoria-->
        ...
        <div class="inline-block min-w-full overflow-hidden rounded-lg shadow mb-4">
            <table class="w-full whitespace-no-wrap">
                ...
                <!--FILAS-->
                <tbody>
                    <tr v-for="categoria in categorias" :key="categoria.id" class="text-gray-700">

                        <td class="border-b border-gray-200 dark:border-slate-700  bg-white dark:bg-slate-800 px-5 py-5 text-sm">
                            <p class="text-gray-900 dark:text-gray-200 whitespace-no-wrap">{{ categoria.id }}</p>
                        </td>

                        <td class="border-b border-gray-200 dark:border-slate-700  bg-white dark:bg-slate-800 px-5 py-5 text-sm">
                            <p class="text-gray-900 dark:text-gray-200 whitespace-no-wrap">{{ categoria.Descripcion }}</p>
                        </td>

                        <td class="border-b border-gray-200 dark:border-slate-700  bg-white dark:bg-slate-800 px-5 py-5 text-sm">
                            <p class="text-gray-900 dark:text-gray-200 whitespace-no-wrap">{{ categoria.Clave }}</p>
                        </td>
                        ...
                        class="border-b border-gray-200 dark:border-slate-700  bg-white dark:bg-slate-800 px-5 py-5 text-sm">
                            ...
                            v-tippy="{
                                content:'Editar categoria de plaza',
                                placement: 'top' ,
                                arrow: true,
                                arrowType: 'MyArrow',
                                theme: 'MiThemeBlue'
                            ...
                            v-tippy="{
                                content:'Eliminar categoria de plaza',
                                placement: 'top' ,
                                arrow: true,
                                arrowType: 'MyArrow',
                                theme: 'MiThemeRed'
                            ...
                            <div>
                                <div :class="{ hidden: !isvisibleDelete }" v-bind:id="`Modal${categoria.id}`" tabindex="-1" class="fixed inset-0 flex items-center justify-center z-50">
                                    <div class="relative w-full max-w-md max-h-full">
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-6 text-center">
                                                ...
                                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Esta seguro de eliminar a la categoría: {{ nameBorrarSeleccionado }} </h3>
                                                <Link @click="hideDelete" method="delete" :href="route('categorias.destroy', idBorrarSeleccionado)" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                                    Si, estoy seguro
                                                </Link>
        ...
        <!--PAGINACION-->
        <nav aria-label="Page navigation example mt-4 w-full justify-center items-center">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            HacerBusqueda(){
                axios.get('categorias.buscar',{   params:{ categoria:this.CategoriaBuscar,campo:this.campoBusqueda}   })
                .then(response => {
                    this.resultadosBusqueda=response.data;
                    this.$page.props.categorias=this.resultadosBusqueda;
                })
                .catch(error => {
