<template>
    ...
    <header class="flex items-center justify-between border-b-2 border-[#014E82] dark:border-slate-500 w-screen    bg-white  dark:bg-slate-800 px-6 py-4" v-if="Edicion">
        ...
        <div class="flex items-center">
            ...
            <button @click="GuardarCambios" class="px-4 py-2 bg-[#014E82] rounded-md text-gray-200 ml- relative inline-flex ">
            Guardar cambios</button>
        </div>
    </header>
    <!-- Capa oscura -->
    <div :class="{ hidden: !isVisibleEmpalme }" class="fixed inset-0 bg-black opacity-50">
    </div>
    <!--Contenido del panel-->
    <div class="bg-gray-200 w-screen min-h-screen dark:bg-gray-800 overflow-x-auto overflow-y-auto">
        <main class="inset-0 h-auto w-screen bg-gray-200 dark:bg-gray-800 overflow-x-auto overflow-y-auto pb-10 " >
            ...
            <!--MENSAJE DE EMPALME-->
            <div>
                <div :class="{ hidden: !isVisibleEmpalme }"  tabindex="-1" class="fixed inset-0 flex items-center justify-center z-50">
                    <div class="relative w-full max-w-md max-h-full">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            <button @click="hideEmpalme" type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="popup-modal">
                            ...
                            <div class="p-6 text-center">
                                ...
                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                    Aun hay empalmes en el horario favor de revisar
                                </h3>
                                <button @click="hideEmpalme" class="text-white bg-[#014E82] hover:bg-[#0284c7] focus:ring-4 focus:outline-none  dark:focus:bg-[#0284c7]  font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                    Aceptar
                                </button>
...
<script>
    ...
    export default {
        ...
        methods:{
            showEmpalme(){
                this.isVisibleEmpalme=true;
            },
            hideEmpalme(){
                this.isVisibleEmpalme=false;
            },
            ComprobarCampos(){
            ...
            //Esta funcion mueve una clase hacia atras si asi lo corresponde
            //Ejemplo
            //Se tiene la clase 11:00 a 12:00
            //Se ingresa una clase de 8:00 a 9:00
            //Mover clase de 8:00 a 9:00 antes de la clase 11:00 a 12:00
            ...
            //Esta funcion mueve una clase hacia adelante si asi lo corresponde
            //Ejemplo
            //Se tiene la clase 11:00 a 12:00 y una de 8:00 a 9:00
            //Se cambia la hora de la clase de 8:00 a 9:00 a 13:00 a 14:00
            //Mover clase recien cambiada de 13:00 a 14:00 despues de la clase 11:00 a 12:00
            ...
            //Funcion desde donde se llamna las dos funciones anteriores
            ComprobarEmpalmes(){
