...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <!--Modal para agregar permisos de carrera-->
        ...
        <!--Modal para agregar permisos de sistema-->
        <div id="modalContainer">
            <!-- Main modal -->
        ...
        <!--Seccion para seleccion de usuario-->
